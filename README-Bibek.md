...
The adapter file is here -> lib/active_merchant/billing/gateways/awesome_sauce.rb
and test files are here -> test/unit/gateways/awesome_sauce_test.rb
...
See here: https://github.com/activemerchant/active_merchant/wiki/contributing
